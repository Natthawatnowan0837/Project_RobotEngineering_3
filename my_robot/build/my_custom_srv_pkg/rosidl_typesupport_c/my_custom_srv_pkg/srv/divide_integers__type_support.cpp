...
static const _DivideIntegers_Request_type_support_symbol_names_t _DivideIntegers_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_srv_pkg, srv, DivideIntegers_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_srv_pkg, srv, DivideIntegers_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_srv_pkg, srv, DivideIntegers_Request)() {
  return &::my_custom_srv_pkg::srv::rosidl_typesupport_c::DivideIntegers_Request_message_type_support_handle;
}
...
static const _DivideIntegers_Response_type_support_symbol_names_t _DivideIntegers_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_srv_pkg, srv, DivideIntegers_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_srv_pkg, srv, DivideIntegers_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_srv_pkg, srv, DivideIntegers_Response)() {
  return &::my_custom_srv_pkg::srv::rosidl_typesupport_c::DivideIntegers_Response_message_type_support_handle;
}
...
static const _DivideIntegers_type_support_symbol_names_t _DivideIntegers_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_srv_pkg, srv, DivideIntegers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_custom_srv_pkg, srv, DivideIntegers)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_custom_srv_pkg, srv, DivideIntegers)() {
  return &::my_custom_srv_pkg::srv::rosidl_typesupport_c::DivideIntegers_service_type_support_handle;
}
