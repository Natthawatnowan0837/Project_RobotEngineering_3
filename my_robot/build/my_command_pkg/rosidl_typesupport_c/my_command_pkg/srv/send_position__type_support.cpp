...
static const _SendPosition_Request_type_support_symbol_names_t _SendPosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_command_pkg, srv, SendPosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_command_pkg, srv, SendPosition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_command_pkg, srv, SendPosition_Request)() {
  return &::my_command_pkg::srv::rosidl_typesupport_c::SendPosition_Request_message_type_support_handle;
}
...
static const _SendPosition_Response_type_support_symbol_names_t _SendPosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_command_pkg, srv, SendPosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_command_pkg, srv, SendPosition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_command_pkg, srv, SendPosition_Response)() {
  return &::my_command_pkg::srv::rosidl_typesupport_c::SendPosition_Response_message_type_support_handle;
}
...
static const _SendPosition_type_support_symbol_names_t _SendPosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_command_pkg, srv, SendPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_command_pkg, srv, SendPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_command_pkg, srv, SendPosition)() {
  return &::my_command_pkg::srv::rosidl_typesupport_c::SendPosition_service_type_support_handle;
}
