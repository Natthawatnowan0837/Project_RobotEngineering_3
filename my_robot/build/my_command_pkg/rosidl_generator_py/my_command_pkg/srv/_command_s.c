...
bool my_command_pkg__srv__command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_command_pkg.srv._command.Command_Request", full_classname_dest, 43) == 0);
  }
  my_command_pkg__srv__Command_Request * ros_message = _ros_message;
  {  // command
...
PyObject * my_command_pkg__srv__command__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_command_pkg.srv._command");
...
ROSIDL_GENERATOR_C_EXPORT
bool my_command_pkg__srv__command__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_command_pkg.srv._command.Command_Response", full_classname_dest, 44) == 0);
  }
  my_command_pkg__srv__Command_Response * ros_message = _ros_message;
  {  // pos_x
  ...
  {  // pos_z
    ...
    assert(PyLong_Check(field));
    ros_message->pos_z = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * my_command_pkg__srv__command__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // pos_z
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->pos_z);
    {
