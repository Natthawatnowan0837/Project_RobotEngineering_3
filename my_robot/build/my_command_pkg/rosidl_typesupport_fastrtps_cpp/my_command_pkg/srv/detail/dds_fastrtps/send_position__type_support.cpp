...
#include "my_command_pkg/srv/detail/send_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_command_pkg::srv::SendPosition_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: send_x
  cdr << ros_message.send_x;
  // Member: send_y
  cdr << ros_message.send_y;
  // Member: send_z
  cdr << ros_message.send_z;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_command_pkg::srv::SendPosition_Request & ros_message)
{
  // Member: send_x
  cdr >> ros_message.send_x;
  ...
  size_t current_alignment)
{
  ...
  // Member: send_x
  {
    size_t item_size = sizeof(ros_message.send_x);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: send_y
  {
    size_t item_size = sizeof(ros_message.send_y);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: send_z
  {
    size_t item_size = sizeof(ros_message.send_z);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_command_pkg::srv::SendPosition_Request;
    is_plain =
      (
      offsetof(DataType, send_z) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const my_command_pkg::srv::SendPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_command_pkg::srv::SendPosition_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_command_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<my_command_pkg::srv::SendPosition_Request>()
{
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_command_pkg, srv, SendPosition_Request)() {
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_command_pkg
cdr_serialize(
  const my_command_pkg::srv::SendPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: message
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_command_pkg::srv::SendPosition_Response & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_command_pkg::srv::SendPosition_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_command_pkg::srv::SendPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_command_pkg::srv::SendPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_command_pkg, srv, SendPosition_Response)() {
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition_Response__handle;
}
...
{
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_command_pkg, srv, SendPosition)() {
  return &my_command_pkg::srv::typesupport_fastrtps_cpp::_SendPosition__handle;
}
