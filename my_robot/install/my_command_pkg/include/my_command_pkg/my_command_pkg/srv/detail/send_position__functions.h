...
#ifndef MY_COMMAND_PKG__SRV__DETAIL__SEND_POSITION__FUNCTIONS_H_
#define MY_COMMAND_PKG__SRV__DETAIL__SEND_POSITION__FUNCTIONS_H_
...
#include "my_command_pkg/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_my_command_pkg
bool
 ...
 * calls
 * my_command_pkg__srv__SendPosition_Request__init().
...
/**
 * It calls
 * my_command_pkg__srv__SendPosition_Request__fini()
...
/// Check for srv/SendPosition message equality.
/**
...
/// Copy a srv/SendPosition message.
/**
 ...
 * my_command_pkg__srv__SendPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_command_pkg__srv__SendPosition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendPosition message array equality.
/**
...
/// Copy an array of srv/SendPosition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_command_pkg__srv__SendPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_command_pkg
...
/**
 * It calls
 * my_command_pkg__srv__SendPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_command_pkg
...
/**
 * It allocates the memory for the array and calls
 * my_command_pkg__srv__SendPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_command_pkg
...
/**
 * It calls
 * my_command_pkg__srv__SendPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_COMMAND_PKG__SRV__DETAIL__SEND_POSITION__FUNCTIONS_H_
