...
class Command_Response(metaclass=Metaclass_Command_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.pos_z = kwargs.get('pos_z', int())
    ...
    def pos_z(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pos_z' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pos_z' field must be an integer in [-2147483648, 2147483647]"
        self._pos_z = value
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_command_pkg.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from my_command_pkg.srv._command import Command_Request as Request
    from my_command_pkg.srv._command import Command_Response as Response
