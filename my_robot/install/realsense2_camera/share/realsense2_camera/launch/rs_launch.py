...
configurable_parameters = [
    ...
    # ตั้งค่าความละเอียดต่ำสุด พร้อม fps ที่ชัดเจน (กล้องรองรับ)
    ...
    {'name': 'infra_height',         'default': '240', 'description': 'infra height'},
    ...
    {'name': 'fisheye_height',       'default': '-1', 'description': 'fisheye height'},
    {'name': 'enable_fisheye1',      'default': 'true', 'description': 'enable fisheye1 stream'},
    {'name': 'enable_fisheye2',      'default': 'true', 'description': 'enable fisheye2 stream'},

    {'name': 'confidence_width',     'default': '-1', 'description': 'confidence width'},
    {'name': 'confidence_height',    'default': '-1', 'description': 'confidence height'},
    {'name': 'enable_confidence',    'default': 'true', 'description': 'enable confidence stream'},
    ...
    {'name': 'reconnect_timeout',    'default': '6.', 'description': 'Timeout(seconds) between consecutive reconnection attempts'},
]
